  ...
  return (
    <>
      <div className="Information_Section">
        ...
        <div>
          <p>
            The matharu steel Group privacy policy has been compiled to better
            serve those who are concerned with how their ‘Personally
            identifiable information (PII) is being used online. PII, as used in
          ...
          <p>
            ...
            asked to enter your name, email address, Company or other details to
            help you with your experience.
          </p>

          <h3>When do we collect information?</h3>
          <p>
            We collect information from you when you Downloading Catalogs or
          ...
          <p>
            We do not need an SSL because Our website is getting regular
          ...
          <p>
            ...
            (like Internet Explorer) settings. Each browser is a little
            different, so look at your browser’s Help menu to learn the correct
            way to modify your cookies. If you disable cookies off, some
            features will be disabled that make your site experience more
            efficient and some of our se
          </p>
          <h4>However, you can still place orders.</h4>
          ...
          <p>
            ...
            <h6>
              ...
              <a
                ...
                alt="Steel"
              >
                https://goo.gl/maps/5QdwjuJHVvUfJFZY8
              </a>
            </h6>
          </p>
          ...
          <p>
            ...
            the Network Advertising Initiative opt out a page or permanently
          ...
          <h3>We will notify the users via email</h3>
          <p>∙ Within 7 business days</p>

          <h3>We will notify the users via in site notification</h3>
          <p>∙ Within 7 business days</p>
          <p>
          ...
          <p>
            ...
            out tough penalties for violations. We collect your email address in
            order to: To be in accordance with CANSPAM we agree to the
            following: If at any time you would like to unsubscribe from
            receiving future emails, you can and we will promptly remove you
          ...
          <h3>Matharu Steel Group</h3>
          <p>
            Corpotate Office :VILL-KUMBH, NEAR S.D. PIPE PLANT, AMLOH ROAD,
            MANDI GOBINDGARH, Fatehgarh Sahib, Punjab, 147301
          </p>

          <p>+91 9988013139 / support@tmtsal.com</p>
        </div>
      </div>
    </>
  );
